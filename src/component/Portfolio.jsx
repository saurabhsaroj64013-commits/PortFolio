...
import reactjs from "../../public/reactim.png"
import nodejs from "../../public/nodein.jpg"
...
function Portfolio() {
  ...
  return (
    <div name="Portfolio"
    className="max-w-screen-2xl container mx-auto md:px-20 mt-10">
        <div>
                    ...
                    cardItem.map(({id,logo,name}) =>(
                        <div className="md:w-[300px] md:h-[300px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300" key={id}>
                            ...
                            <div className="px-6 py-4 space-x-3 justify-around">
                                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounder">Video</button>
                                <button className="bg-green-500 hover:bg-green-700 text-white font-bold px-4 py-2 rounder">Source code</button>
                            </div>
